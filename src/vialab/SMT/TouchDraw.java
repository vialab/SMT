package vialab.SMT;
    ...
    /**
     * Used to specify what kind of touch visualization and information to display.<P>
     * NONE - None disables all drawing of the touches. It likely should not be used unless an OS-based or the sketch itself is providing the visualisation of the touches.<P>
     * DEBUG - Debug mode will show some debugging info near the touch path, and some extra debug messages on the console.<P>
