...
class SMTTuioListener implements TuioListener {
	...
	private List<TuioCursor> currentTouchState = new ArrayList<TuioCursor>();
	private List<TuioObject> currentObjectState = new ArrayList<TuioObject>();
